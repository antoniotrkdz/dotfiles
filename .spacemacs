...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; lazy install consoleany layer that support lazy installation even the layers
